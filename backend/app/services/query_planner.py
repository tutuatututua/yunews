...
_PLANNER_SYSTEM = (
    ...
    "- First decide if the question is stock, currency or financial related (stocks/companies/markets/gold/business news). If it is not, set is_stock_related=false.\n"
    "- If you are unsure whether the question is related, set is_stock_related=true.\n"
